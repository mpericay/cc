...
<head>
	...
	ga('create', 'UA-11838433-22', 'auto');
	ga('create', 'UA-11838433-10', 'auto', 'generalMuseu');
	ga('send', 'pageview');
	</script>
		  ...
		  <div class="modal-dialog modal-lg">
			...
			<div class="modal-content modal-loc">
			  <div class="modal-header">
				...
				<h4 class="modal-title">Cercar projecte prop de ... <span class='text-muted'>(arrossegar el marcador i prémer Seleccionar)</span></h4>
			  </div>
